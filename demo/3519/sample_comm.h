...
td_void sample_comm_sys_get_default_vb_cfg(sample_vb_param *input_cfg,
                                           ot_vb_cfg *vb_cfg);
td_void sample_comm_sys_get_default_cfg(td_u32 pipe_num,
...
td_s32 sample_comm_sys_init_with_vb_supplement(const ot_vb_cfg *vb_cfg,
                                               td_u32 supplement_config);

td_s32 sample_comm_vi_bind_vo(ot_vi_pipe vi_pipe, ot_vi_chn vi_chn,
                              ot_vo_layer vo_layer, ot_vo_chn vo_chn);
td_s32 sample_comm_vi_un_bind_vo(ot_vi_pipe vi_pipe, ot_vi_chn vi_chn,
                                 ot_vo_layer vo_layer, ot_vo_chn vo_chn);
td_s32 sample_comm_vi_bind_vpss(ot_vi_pipe vi_pipe, ot_vi_chn vi_chn,
                                ot_vpss_grp vpss_grp, ot_vpss_chn vpss_chn);
td_s32 sample_comm_vi_un_bind_vpss(ot_vi_pipe vi_pipe, ot_vi_chn vi_chn,
                                   ot_vpss_grp vpss_grp, ot_vpss_chn vpss_chn);
td_s32 sample_comm_vi_bind_venc(ot_vi_pipe vi_pipe, ot_vi_chn vi_chn,
                                ot_venc_chn venc_chn);
td_s32 sample_comm_vi_un_bind_venc(ot_vi_pipe vi_pipe, ot_vi_chn vi_chn,
                                   ot_venc_chn venc_chn);
td_s32 sample_comm_avs_bind_venc(ot_avs_grp avs_grp, ot_avs_chn avs_chn,
                                 ot_venc_chn venc_chn);
td_s32 sample_comm_avs_un_bind_venc(ot_avs_grp avs_grp, ot_avs_chn avs_chn,
                                    ot_venc_chn venc_chn);
td_s32 sample_comm_avs_bind_vo(ot_avs_grp avs_grp, ot_avs_chn avs_chn,
                               ot_vo_layer vo_layer, ot_vo_chn vo_chn);
td_s32 sample_comm_avs_un_bind_vo(ot_avs_grp avs_grp, ot_avs_chn avs_chn,
                                  ot_vo_layer vo_layer, ot_vo_chn vo_chn);

td_s32 sample_comm_vi_switch_isp_mode(const sample_vi_cfg *vi_cfg);
td_s32 sample_comm_vi_switch_isp_resolution(const sample_vi_cfg *vi_cfg,
                                            const ot_size *size);
td_void sample_comm_vi_mode_switch_stop_vi(const sample_vi_cfg *vi_cfg);
td_s32 sample_comm_vi_mode_switch_start_vi(const sample_vi_cfg *vi_cfg,
                                           td_bool chg_resolution,
                                           const ot_size *size);

td_s32 sample_comm_vpss_bind_vo(ot_vpss_grp vpss_grp, ot_vpss_chn vpss_chn,
                                ot_vo_layer vo_layer, ot_vo_chn vo_chn);
td_s32 sample_comm_vpss_un_bind_vo(ot_vpss_grp vpss_grp, ot_vpss_chn vpss_chn,
                                   ot_vo_layer vo_layer, ot_vo_chn vo_chn);
td_s32 sample_comm_vpss_bind_avs(ot_vpss_grp vpss_grp, ot_vpss_chn vpss_chn,
                                 ot_avs_grp avs_grp, ot_avs_pipe avs_pipe);
td_s32 sample_comm_vpss_un_bind_avs(ot_vpss_grp vpss_grp, ot_vpss_chn vpss_chn,
                                    ot_avs_grp avs_grp, ot_avs_pipe avs_pipe);

td_s32 sample_comm_vpss_bind_venc(ot_vpss_grp vpss_grp, ot_vpss_chn vpss_chn,
                                  ot_venc_chn venc_chn);
td_s32 sample_comm_vpss_un_bind_venc(ot_vpss_grp vpss_grp, ot_vpss_chn vpss_chn,
                                     ot_venc_chn venc_chn);
td_s32 sample_comm_vdec_bind_vpss(ot_vdec_chn vdec_chn, ot_vpss_grp vpss_grp);
td_s32 sample_comm_vdec_un_bind_vpss(ot_vdec_chn vdec_chn,
                                     ot_vpss_grp vpss_grp);
td_s32 sample_comm_vo_bind_vo(ot_vo_layer src_vo_layer, ot_vo_chn src_vo_chn,
                              ot_vo_layer dst_vo_layer, ot_vo_chn dst_vo_chn);
td_s32 sample_comm_vo_un_bind_vo(ot_vo_layer dst_vo_layer,
                                 ot_vo_chn dst_vo_chn);

td_s32 sample_comm_isp_sensor_regiter_callback(ot_isp_dev isp_dev,
                                               sample_sns_type sns_type);
td_s32 sample_comm_isp_sensor_unregiter_callback(ot_isp_dev isp_dev);
td_s32 sample_comm_isp_bind_sns(ot_isp_dev isp_dev, sample_sns_type sns_type,
                                td_s8 sns_dev);
...
td_s32 sample_comm_isp_get_pub_attr_by_sns(sample_sns_type sns_type,
                                           ot_isp_pub_attr *pub_attr);
ot_isp_sns_type sample_comm_get_sns_bus_type(sample_sns_type sns_type);
td_void sample_comm_vi_get_size_by_sns_type(sample_sns_type sns_type,
                                            ot_size *size);
td_u32 sample_comm_vi_get_obheight_by_sns_type(sample_sns_type sns_type);
td_void sample_comm_vi_get_default_vi_cfg(sample_sns_type sns_type,
                                          sample_vi_cfg *vi_cfg);
td_void sample_comm_vi_get_vi_cfg_by_fmu_mode(sample_sns_type sns_type,
                                              ot_fmu_mode fum_mode,
                                              sample_vi_cfg *vi_cfg);
td_void sample_comm_vi_init_vi_cfg(sample_sns_type sns_type, ot_size *size,
                                   sample_vi_cfg *vi_cfg);
...
td_void sample_comm_vi_stop_four_vi(const sample_vi_cfg *vi_cfg,
                                    td_s32 route_num);
td_s32 sample_comm_vi_fpn_calibrate(
    ot_vi_pipe vi_pipe, sample_vi_fpn_calibration_cfg *calibration_cfg);
td_s32 sample_comm_vi_enable_fpn_correction(
    ot_vi_pipe vi_pipe, sample_vi_fpn_correction_cfg *correction_cfg);
td_s32 sample_comm_vi_disable_fpn_correction(
    ot_vi_pipe vi_pipe, sample_vi_fpn_correction_cfg *correction_cfg);

td_s32 sample_comm_vi_fpn_calibrate_for_thermo(
    ot_vi_pipe vi_pipe, sample_vi_fpn_calibration_cfg *calibration_cfg);
td_s32 sample_comm_vi_enable_fpn_correction_for_thermo(
    ot_vi_pipe vi_pipe, sample_vi_fpn_correction_cfg *correction_cfg);
td_s32 sample_comm_vi_disable_fpn_correction_for_thermo(
    ot_vi_pipe vi_pipe, sample_vi_fpn_correction_cfg *correction_cfg);

td_s32 sample_comm_vi_enable_fpn_correction_for_scene(
    ot_vi_pipe vi_pipe, sample_vi_fpn_correction_cfg *correction_cfg,
...
td_s32 sample_common_vi_load_user_pic(
    ot_vi_pipe vi_pipe, sample_vi_user_pic_type user_pic_type,
    sample_vi_user_frame_info *user_frame_info);
td_void sample_common_vi_unload_user_pic(
    sample_vi_user_frame_info *user_frame_info);
...
td_void sample_comm_vpss_get_default_vpss_cfg(sample_vpss_cfg *vpss_cfg,
                                              ot_fmu_mode vpss_fmu);
td_s32 sample_common_vpss_start(ot_vpss_grp grp,
                                const ot_vpss_grp_attr *grp_attr,
                                const sample_vpss_chn_attr *vpss_chn_attr);
td_s32 sample_common_vpss_stop(ot_vpss_grp grp, const td_bool *chn_enable,
                               td_u32 chn_array_size);

td_s32 sample_comm_vo_get_width_height(ot_vo_intf_sync intf_sync, td_u32 *width,
...
td_s32 sample_comm_vo_start_layer(ot_vo_layer vo_layer,
                                  const ot_vo_video_layer_attr *layer_attr);
td_s32 sample_comm_vo_stop_layer(ot_vo_layer vo_layer);
td_s32 sample_comm_vo_get_wnd_info(sample_vo_mode mode,
                                   sample_vo_wnd_info *wnd_info);
td_s32 sample_comm_vo_get_chn_attr(sample_vo_wnd_info *wnd_info,
...
td_s32 sample_comm_vo_bind_vi(ot_vo_layer vo_layer, ot_vo_chn vo_chn,
                              ot_vi_chn vi_chn);
...
td_s32 sample_comm_vo_get_def_layer_config(
    sample_comm_vo_layer_cfg *vo_layer_config);
td_s32 sample_comm_vo_start_layer_chn(
    sample_comm_vo_layer_cfg *vo_layer_config);
td_s32 sample_comm_vo_stop_layer_chn(sample_comm_vo_layer_cfg *vo_layer_config);

td_s32 sample_comm_venc_mem_config(td_void);
td_s32 sample_comm_venc_create(ot_venc_chn venc_chn,
                               sample_comm_venc_chn_param *chn_param);
td_s32 sample_comm_venc_start(ot_venc_chn venc_chn,
                              sample_comm_venc_chn_param *chn_param);
td_s32 sample_comm_venc_stop(ot_venc_chn venc_chn);
td_s32 sample_comm_venc_snap_start(ot_venc_chn venc_chn, ot_size *size,
                                   td_bool support_dcf);
td_s32 sample_comm_venc_photo_start(ot_venc_chn venc_chn, ot_size *size,
                                    td_bool support_dcf);
td_s32 sample_comm_venc_snap_process(ot_venc_chn venc_chn, td_u32 snap_cnt,
...
td_s32 sample_comm_venc_get_gop_attr(ot_venc_gop_mode gop_mode,
                                     ot_venc_gop_attr *gop_attr);
td_s32 sample_comm_venc_qpmap_send_frame(ot_vpss_grp vpss_grp,
                                         ot_vpss_chn vpss_chn[],
                                         ot_venc_chn venc_chn[], td_s32 cnt,
                                         ot_size size[]);
td_s32 sample_comm_venc_stop_send_qpmap_frame(td_void);
td_s32 sample_comm_venc_rateauto_start(ot_venc_chn ve_chn[], td_s32 cnt,
                                       ot_vpss_grp vpss_grp,
                                       ot_vpss_chn vpss_chn[]);
td_s32 sample_comm_venc_stop_rateauto(ot_venc_chn ve_chn[], td_s32 cnt);

td_s32 sample_comm_venc_get_file_postfix(ot_payload_type payload,
                                         td_char *file_postfix, td_u8 len);
td_s32 sample_comm_venc_send_roimap_frame(
...
td_s32 sample_comm_venc_mosaic_map_send_frame(ot_vpss_grp vpss_grp,
                                              ot_vpss_chn vpss_chn[],
                                              ot_venc_chn venc_chn[],
...
td_s32 sample_comm_region_attach(td_s32 handle_num, ot_rgn_type type,
                                 ot_mpp_chn *mpp_chn, region_op_flag op_flag);
td_s32 sample_comm_check_min(td_s32 min_handle);
td_s32 sample_comm_region_detach(td_s32 handle_num, ot_rgn_type type,
                                 ot_mpp_chn *mpp_chn, region_op_flag op_flag);
td_s32 sample_comm_region_set_bit_map(ot_rgn_handle handle,
                                      const td_char *bmp_path);
td_s32 sample_comm_region_get_up_canvas(ot_rgn_handle handle,
                                        const td_char *bmp_path);
...
td_s32 sample_comm_audio_create_thread_ai_ao(ot_audio_dev ai_dev,
                                             ot_ai_chn ai_chn,
                                             ot_audio_dev ao_dev,
                                             ot_ao_chn ao_chn);
td_s32 sample_comm_audio_create_thread_ai_aenc(ot_audio_dev ai_dev,
                                               ot_ai_chn ai_chn,
                                               ot_aenc_chn ae_chn);
td_s32 sample_comm_audio_create_thread_aenc_adec(ot_aenc_chn ae_chn,
                                                 ot_adec_chn ad_chn,
                                                 FILE *aenc_fd);
td_s32 sample_comm_audio_create_thread_file_adec(ot_adec_chn ad_chn,
                                                 FILE *adec_fd);
td_s32 sample_comm_audio_create_thread_ao_vol_ctrl(ot_audio_dev ao_dev);
td_s32 sample_comm_audio_destroy_thread_ai(ot_audio_dev ai_dev,
                                           ot_ai_chn ai_chn);
...
td_s32 sample_comm_audio_ao_bind_adec(ot_audio_dev ao_dev, ot_ao_chn ao_chn,
                                      ot_adec_chn ad_chn);
td_s32 sample_comm_audio_ao_unbind_adec(ot_audio_dev ao_dev, ot_ao_chn ao_chn,
                                        ot_adec_chn ad_chn);
td_s32 sample_comm_audio_ao_bind_ai(ot_audio_dev ai_dev, ot_ai_chn ai_chn,
                                    ot_audio_dev ao_dev, ot_ao_chn ao_chn);
td_s32 sample_comm_audio_ao_unbind_ai(ot_audio_dev ai_dev, ot_ai_chn ai_chn,
                                      ot_audio_dev ao_dev, ot_ao_chn ao_chn);
td_s32 sample_comm_audio_aenc_bind_ai(ot_audio_dev ai_dev, ot_ai_chn ai_chn,
                                      ot_aenc_chn ae_chn);
td_s32 sample_comm_audio_aenc_unbind_ai(ot_audio_dev ai_dev, ot_ai_chn ai_chn,
                                        ot_aenc_chn ae_chn);
td_s32 sample_comm_audio_start_ai(ot_audio_dev ai_dev_id, td_u32 ai_chn_cnt,
                                  ot_aio_attr *aio_attr,
                                  const sample_comm_ai_vqe_param *ai_vqe_param,
                                  ot_audio_dev ao_dev_id);
td_s32 sample_comm_audio_stop_ai(ot_audio_dev ai_dev_id, td_u32 ai_chn_cnt,
...
td_s32 sample_comm_audio_start_ao(ot_audio_dev ao_dev_id, td_u32 ao_chn_cnt,
                                  ...
                                  td_bool resample_en);
td_s32 sample_comm_audio_stop_ao(ot_audio_dev ao_dev_id, td_u32 ao_chn_cnt,
                                 td_bool resample_en);
td_s32 sample_comm_audio_start_aenc(td_u32 aenc_chn_cnt,
                                    const ot_aio_attr *aio_attr,
                                    ot_payload_type type);
td_s32 sample_comm_audio_stop_aenc(td_u32 aenc_chn_cnt);
td_s32 sample_comm_audio_start_adec(td_u32 adec_chn_cnt,
                                    const ot_aio_attr *aio_attr,
                                    ot_payload_type type);
td_s32 sample_comm_audio_stop_adec(ot_adec_chn ad_chn);
td_s32 sample_comm_audio_cfg_acodec(const ot_aio_attr *aio_attr);

td_s32 sample_comm_vdec_init_vb_pool(td_u32 chn_num,
                                     sample_vdec_attr *past_sample_vdec,
                                     td_u32 arr_len);
td_void sample_comm_vdec_exit_vb_pool(td_void);
td_void sample_comm_vdec_cmd_ctrl(td_s32 chn_num, vdec_thread_param *vdec_send,
                                  pthread_t *vdec_thread, td_u32 send_arr_len,
                                  td_u32 thread_arr_len);
td_void sample_comm_vdec_start_send_stream(td_s32 chn_num,
                                           vdec_thread_param *vdec_send,
                                           pthread_t *vdec_thread,
                                           td_u32 send_arr_len,
                                           td_u32 thread_arr_len);
td_void sample_comm_vdec_stop_send_stream(td_s32 chn_num,
                                          vdec_thread_param *vdec_send,
                                          pthread_t *vdec_thread,
                                          td_u32 send_arr_len,
                                          td_u32 thread_arr_len);
td_void *sample_comm_vdec_send_stream(td_void *args);
td_s32 sample_comm_vdec_start(td_s32 chn_num,
                              sample_vdec_attr *past_sample_vdec,
                              td_u32 arr_len);
td_s32 sample_comm_vdec_stop(td_s32 chn_num);
td_void sample_comm_vdec_cmd_not_circle_send(td_u32 chn_num,
                                             vdec_thread_param *vdec_send,
                                             pthread_t *vdec_thread,
                                             td_u32 send_arr_len,
                                             td_u32 thread_arr_len);
td_void sample_comm_vdec_print_chn_status(td_s32 chn,
...
td_void sample_comm_vi_get_default_sns_info(sample_sns_type sns_type,
                                            sample_sns_info *sns_info);
td_void sample_comm_vi_get_default_pipe_info(sample_sns_type sns_type,
                                             ot_vi_bind_pipe *bind_pipe,
                                             sample_vi_pipe_info pipe_info[]);

td_void sample_comm_vi_get_default_mipi_info(sample_sns_type sns_type,
                                             sample_mipi_info *mipi_info);
td_void sample_comm_vi_get_default_dev_info(sample_sns_type sns_type,
                                            sample_vi_dev_info *dev_info);
td_void sample_comm_vi_get_mipi_info_by_dev_id(sample_sns_type sns_type,
                                               ot_vi_dev vi_dev,
                                               sample_mipi_info *mipi_info);
...
td_u32 sample_comm_vi_get_raw_stride(ot_pixel_format pixel_format, td_u32 width,
                                     td_u32 byte_align, td_u32 align);
td_s32 sample_comm_vi_read_raw_frame(
