...
objects *objects_construct(const configs *cfgs) {
  ...
  objs->src_hops_mics_object = src_hops_construct(
  ...
  objs->mod_mapping_mics_object = mod_mapping_construct(
  ...
  objs->mod_resample_mics_object = mod_resample_construct(
  ...
  objs->mod_stft_mics_object = mod_stft_construct(
  ...
  objs->mod_noise_mics_object = mod_noise_construct(
  ...
  objs->mod_ssl_object =
      mod_ssl_construct(cfgs->mod_ssl_config, cfgs->msg_spectra_mics_config,
  ...
  objs->snk_pots_ssl_object =
      snk_pots_construct(cfgs->snk_pots_ssl_config, cfgs->msg_pots_ssl_config);
  ...
  objs->inj_targets_sst_object = inj_targets_construct(
  ...
  objs->mod_sst_object = mod_sst_construct(
  ...
  objs->snk_tracks_sst_object = snk_tracks_construct(
  ...
  objs->mod_sss_object =
      mod_sss_construct(cfgs->mod_sss_config, cfgs->msg_tracks_sst_config,
                        cfgs->msg_spectra_mics_config);
  ...
  objs->mod_istft_seps_object = mod_istft_construct(
      cfgs->mod_istft_seps_config, cfgs->msg_spectra_seps_config,
  ...
  objs->mod_resample_seps_object = mod_resample_construct(
      cfgs->mod_resample_seps_config, cfgs->msg_hops_seps_config,
      cfgs->msg_hops_seps_rs_config);

  objs->mod_resample_pfs_object = mod_resample_construct(
  ...
  objs->mod_volume_seps_object = mod_volume_construct(
      cfgs->mod_volume_seps_config, cfgs->msg_hops_seps_vol_config);

  objs->mod_volume_pfs_object = mod_volume_construct(
  ...
  objs->snk_hops_seps_vol_object = snk_hops_construct(
      cfgs->snk_hops_seps_vol_config, cfgs->msg_hops_seps_vol_config);

  objs->snk_hops_pfs_vol_object = snk_hops_construct(
  ...
  objs->mod_classify_object = mod_classify_construct(
  ...
  objs->snk_categories_object = snk_categories_construct(
  ...
  mod_ssl_connect(objs->mod_ssl_object, objs->con_spectra_mics_object->outs[1],
  ...
  mod_sst_connect(objs->mod_sst_object, objs->con_pots_ssl_object->outs[0],
  ...
  mod_sss_connect(objs->mod_sss_object, objs->con_spectra_mics_object->outs[2],
  ...
  mod_classify_connect(
      objs->mod_classify_object, objs->con_hops_seps_object->outs[1],
...
aobjects *aobjects_construct(const configs *cfgs) {
  ...
  objs->amod_resample_mics_object = amod_resample_construct(
      cfgs->mod_resample_mics_config, cfgs->msg_hops_mics_map_config,
      cfgs->msg_hops_mics_rs_config);
  ...
  objs->amod_stft_mics_object = amod_stft_construct(
      cfgs->mod_stft_mics_config, cfgs->msg_hops_mics_rs_config,
      cfgs->msg_spectra_mics_config);
  ...
  objs->amod_noise_mics_object = amod_noise_construct(
      cfgs->mod_noise_mics_config, cfgs->msg_spectra_mics_config,
      cfgs->msg_powers_mics_config);
  ...
  objs->ainj_targets_sst_object = ainj_targets_construct(
      cfgs->inj_targets_sst_config, cfgs->msg_hops_mics_rs_config,
      cfgs->msg_targets_sst_config);
  ...
  objs->amod_sst_object = amod_sst_construct(
      cfgs->mod_sst_config, cfgs->mod_ssl_config, cfgs->msg_pots_ssl_config,
      cfgs->msg_targets_sst_config, cfgs->msg_tracks_sst_config);
  ...
  objs->amod_istft_seps_object = amod_istft_construct(
      cfgs->mod_istft_seps_config, cfgs->msg_spectra_seps_config,
      cfgs->msg_hops_seps_config);

  objs->amod_istft_pfs_object = amod_istft_construct(
  ...
  objs->amod_resample_seps_object = amod_resample_construct(
      cfgs->mod_resample_seps_config, cfgs->msg_hops_seps_config,
      cfgs->msg_hops_seps_rs_config);

  objs->amod_resample_pfs_object = amod_resample_construct(
      cfgs->mod_resample_pfs_config, cfgs->msg_hops_pfs_config,
      cfgs->msg_hops_pfs_rs_config);
  ...
  objs->acon_hops_seps_rs_object =
      acon_hops_construct(1, objs->nMessages, cfgs->msg_hops_seps_rs_config);
  ...
  objs->amod_volume_seps_object = amod_volume_construct(
      cfgs->mod_volume_seps_config, cfgs->msg_hops_seps_vol_config);
  ...
  objs->acon_hops_seps_vol_object =
      acon_hops_construct(1, objs->nMessages, cfgs->msg_hops_seps_vol_config);
  ...
  objs->asnk_hops_seps_vol_object = asnk_hops_construct(
      cfgs->snk_hops_seps_vol_config, cfgs->msg_hops_seps_vol_config);
  ...
  objs->amod_classify_object = amod_classify_construct(
      cfgs->mod_classify_config, cfgs->msg_hops_seps_config,
      cfgs->msg_tracks_sst_config, cfgs->msg_categories_config);
  ...
  amod_sst_connect(objs->amod_sst_object, objs->acon_pots_ssl_object->outs[0],
  ...
  amod_sss_connect(
      objs->amod_sss_object, objs->acon_spectra_mics_object->outs[2],
